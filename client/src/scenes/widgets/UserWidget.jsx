...
const UserWidget = ({ userId, picturePath }) => {
  ...
  return (
    <WidgetWrapper>
      ...
      {/* FOURTH ROW */}
      <Box p="1rem 0">
        <Typography fontSize="1rem" color={light} fontWeight="500" mb="1rem">
          Social Profiles
        </Typography>
        <FlexBetween gap="1rem" mb="0.5rem">
          <FlexBetween gap="1rem">
            ...
            <Box>
              ...
              <Typography color={light}>Social network</Typography>
            </Box>
          </FlexBetween>
        ...
        <FlexBetween gap="1rem">
          <FlexBetween gap="1rem">
            ...
            <Box>
              ...
              <Typography color={light}>Network Platform</Typography>
            </Box>
          </FlexBetween>
          <EditOutlined sx={{ color: light }} />
        </FlexBetween>
